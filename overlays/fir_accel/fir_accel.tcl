...
proc create_hier_cell_filter { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins fir_dma/M_AXI_S2MM]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net filter_M_AXI_S2MM [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins filter/M_AXI_S2MM]
